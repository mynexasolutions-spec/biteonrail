      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center flex-wrap gap-4">
          <div>
            ...
            <p className="text-slate-500 text-xs lg:text-sm mt-1">Configure active junction hubs, service timing boundaries, and location parameters.</p>
          </div>
          {adminType === 'global' && (
              ...
              <div className="bg-white border border-slate-200 p-5 rounded-3xl shadow-sm space-y-4">
                <div className="flex justify-between items-center flex-wrap gap-2">
                  <div>
                    ...
                    <p className="text-[11px] lg:text-sm text-slate-500 font-medium">Manage operational window timings, buffers, and active kitchen status.</p>
                  </div>
                  <span className="text-[10px] lg:text-xs text-slate-500 font-black uppercase bg-slate-50 border border-slate-200 px-3.5 py-1.5 rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-3 pt-1">
                  <div className="relative md:col-span-6">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs lg:text-sm focus:outline-none focus:border-rose-500 font-bold text-slate-850 placeholder-slate-400"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="md:col-span-3 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-xs lg:text-sm font-bold text-slate-705 focus:outline-none focus:border-rose-500 cursor-pointer"
                  >
                  ...
                  <select
                    ...
                    className="md:col-span-3 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-xs lg:text-sm font-bold text-slate-750 focus:outline-none focus:border-rose-500 cursor-pointer"
                  >
                          ...
                          return (
                            <tr key={station.id} className="hover:bg-slate-50/50 transition-colors duration-150">
                              <td className="py-3.5 px-5">
                                <div>
                                  <span className="font-extrabold text-slate-800 text-sm lg:text-base block leading-tight">{station.name}</span>
                                  <div className="flex items-center gap-1.5 mt-1">
                                    <span className="bg-rose-50 text-rose-707 border border-rose-100 px-2 py-0.5 rounded font-mono text-[10px] lg:text-xs font-black uppercase">
                                      {station.code}
                                    </span>
                                    <span className="text-xs lg:text-sm text-slate-400 font-bold">{station.state}</span>
                                  </div>
                                </div>
                              </td>
                              <td className="py-3.5 px-5 font-mono text-slate-655">
                                <div className="flex items-center gap-1">
                                  ...
                                  <span className="font-bold text-xs lg:text-sm">{station.open_time || '00:00'} - {station.close_time || '23:59'}</span>
                                </div>
                              </td>
                              <td className="py-3.5 px-5 text-slate-700">
                                {station.manager_phone ? (
                                  <div className="space-y-0.5">
                                    <span className="text-slate-800 text-xs lg:text-sm font-extrabold block">{station.manager_name || 'N/A'}</span>
                                    <a href={`tel:${station.manager_phone}`} className="text-rose-600 hover:text-rose-750 font-mono text-xs lg:text-sm flex items-center gap-1.5 w-fit font-black">
                              ...
                              <td className="py-3.5 px-5 text-center font-bold">
                                <span className="text-xs lg:text-sm text-indigo-650 bg-indigo-50 border border-indigo-105 px-2.5 py-1 rounded-lg">
                                  {station.buffer_minutes || 60} mins
                                </span>
                              </td>
                              <td className="py-3.5 px-5 text-center">
                                <span className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-full font-black text-[10px] lg:text-xs uppercase tracking-wider border ${isActive
              ...
              >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-slate-800 text-xs focus:outline-none focus:border-rose-500 cursor-pointer font-semibold"
                  >
