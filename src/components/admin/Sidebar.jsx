...
import { ChefHat, ClipboardList, Coffee, MapPin, Key, Database, User, Menu, X, LogOut, Phone, Layers, Monitor, Globe, HelpCircle } from 'lucide-react';
...
export default function Sidebar({
  ...
  const tabs = adminType === 'global' ? [
    ...
    { id: 'faqs', label: 'FAQs Manage', icon: HelpCircle },
    ...
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 flex flex-col justify-between shrink-0 transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
          } md:translate-x-0 md:sticky md:top-0 md:h-screen md:transform-none transition-transform duration-300 ease-in-out`}
      >
        {/* Header */}
